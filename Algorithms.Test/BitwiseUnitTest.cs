...
namespace Algorithms.Test
{
    public class BitwiseUnitTest
    {
        ...
        {
            bool[] numbits = Bitwise.GetNextBit(num).ToArray();
        ...
        {
            bool[] output = Bitwise.BitArrayMultiple(lhs, rhs);
        ...
        {
            bool[] output = Bitwise.BitArraySum(lhs, rhs);
        ...
        {
            bool[] output = Bitwise.BitArraySubtract(lhs, rhs);
        ...
        {
            bool[] output = Bitwise.BitArrayRightShift(num, shift);
        ...
        {
            bool[] output = Bitwise.Invert(num);
        ...
        {
            Assert.Equal<bool>(result, Bitwise.IsPowerOfTwo(v));
        }
        ...
        {
            Assert.Equal<ulong>(result, Bitwise.NextPowerOfTwo(num));
        }
        ...
        {
            bool[] output = Bitwise.UnaryMinus(num);
